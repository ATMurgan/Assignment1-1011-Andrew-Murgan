...
public class GpuBarGraphController implements Initializable {
    @FXML
    private CategoryAxis GPUCategoryAxis;

    @FXML
    private NumberAxis GPUNumberAxis;

    @FXML
    private BarChart<String, Double> chartGPU;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        chartGPU.getData().add(DBUtility.getTopGpus());

        GPUNumberAxis.setLabel("Price");
        GPUCategoryAxis.setLabel("Gpu Name");
