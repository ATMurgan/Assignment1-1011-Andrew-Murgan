...
public class CoolerBarGraphController implements Initializable {
    @FXML
    private CategoryAxis CoolerCategoryAxis;

    @FXML
    private NumberAxis CoolerNumberAxis;

    @FXML
    private BarChart<String, Integer> chartCooler;
    ...
    private void handleCheckCPU() {
        if (checkCPU.isSelected()) {
            switchToPage("cpu-bra-graph.fxml");
        }
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        chartCooler.getData().add(DBUtility.getTopCoolers());
        CoolerNumberAxis.setLabel("Price");
        CoolerCategoryAxis.setLabel("Cpu Name");
